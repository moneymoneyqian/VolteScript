...
local_201601 = pd.read_csv('/mnt/shared/201601_local.csv',sep=',',header=None,names=colnames)
local_201602 =pd.read_csv('/mnt/shared/201602_local.csv',sep=',',header=None,names=colnames)
rm_201601 = pd.read_csv('/mnt/shared/201601_rm.csv',sep=',',header=None,names=colnames)
rm_201602 = pd.read_csv('/mnt/shared/201602_rm.csv',sep=',',header=None,names=colnames)
...
data_201601.to_csv('/mnt/shared/data_201601.csv',header=False,index=True,index_lable=False)
data_201602.to_csv('/mnt/shared/data_201602.csv',header=False,index=True,index_lable=False)
data_201601=pd.read_csv('/mnt/shared/data_201601.csv',sep=',',header=None,names=newcolnames)
data_201602=pd.read_csv('/mnt/shared/data_201602.csv',sep=',',header=None,names=newcolnames)
...
data_final_201601_balanced.to_csv('/mnt/shared/data_final_201601_balanced.csv',header=True,index=False,index_lable=False)
data_201601_mark.to_csv('/mnt/shared/data_final_201601_origin.csv',header=True,index=False,index_lable=False)